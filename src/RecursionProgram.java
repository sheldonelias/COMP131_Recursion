...
public class RecursionProgram
{
    public static void main(String[] args) {
        ...
        //ADVISE: Comment out the method calls, and uncomment one at a time.

        //Try this recursive summator of ArrayList of type int
        ...
        recurseWordReverse("hello");

        //Try this iterative summator of all numbers from 0 to your choice of k =?.
        sumIteratePos(5);

        //Try this recursive summator of all numbers from 0 to your choice of k =?.
        sumRecursePos(5);
